...
export class OurWorkComponent implements OnInit {
  ...
  placeArr: any = [
    ...
    { name: 'Fadi Al Barsha', value: 'fadi-barsha', img: 'assets/img/work/fadi-barsha/3.jpg', imgs: [] },
  ...
  ngOnInit(): void {
    ...
    for (let x = 1; x <= 4; x++) this.placeArr[6].imgs.push({ img: `${x}.jpg`, value: 'jabal-ali-mall' })
    for (let x = 1; x <= 4; x++) this.placeArr[7].imgs.push({ img: `${x}.jpg`, value: 'fadi-barsha' })
    for (let x = 1; x <= 4; x++) this.placeArr[8].imgs.push({ img: `${x}.jpg`, value: 'clinic-dubai-jlt' })
    for (let x = 1; x <= 3; x++) this.placeArr[9].imgs.push({ img: `${x}.jpg`, value: 'doors' })
    for (let x = 1; x <= 4; x++) this.placeArr[10].imgs.push({ img: `${x}.jpg`, value: 'donner-kebab' })
    for (let x = 1; x <= 4; x++) this.placeArr[11].imgs.push({ img: `${x}.jpg`, value: 'doner-gyros' })
    for (let x = 1; x <= 4; x++) this.placeArr[12].imgs.push({ img: `${x}.jpg`, value: 'dandanah-cafe' })
    for (let x = 1; x <= 4; x++) this.placeArr[13].imgs.push({ img: `${x}.jpg`, value: 'chineese-restaurant' })
    for (let x = 1; x <= 4; x++) this.placeArr[14].imgs.push({ img: `${x}.jpg`, value: 'bosnian-village' })
    for (let x = 1; x <= 4; x++) this.placeArr[15].imgs.push({ img: `${x}.jpg`, value: 'blenz-cafe' })
    for (let x = 1; x <= 3; x++) this.placeArr[16].imgs.push({ img: `${x}.jpg`, value: 'animal-care' })
